    ...
    async find(ctx) {
      ...
      const newData = data.map((entry) => ({
        ...
        //attributes: {
          ...
          ...entry.attributes,
          locations: entry.attributes.locations && entry.attributes.locations.data ? entry.attributes.locations.data.map(embedIdInAttributes) : [],
        //},
      }));
  ...
  async findOne(ctx) {
    ...
    const newData = {
      //attributes: {
        ...
        ...data.attributes,
        locations: data.attributes.locations && data.attributes.locations.data ? data.attributes.locations.data.map(embedIdInAttributes) : [],
      // },
    };
    return newData;
  },
